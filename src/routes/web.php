...
Route::get('/stamp_correction_request/approve/{attendance_correct_request_id}', [StampController::class, 'showCorrection'])->name('showCorrection');
Route::post('/stamp_correction_request/approve/{attendance_correct_request_id}', [StampController::class, 'stampCorrection'])->name('stampCorrection');